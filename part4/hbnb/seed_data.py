#!/usr/bin/env python3
"""Database population script with sample data."""
...
def seed_database():
    """Populates the database with initial users, places, and reviews."""
    with app.app_context():
        ...
        # L'Admin a un Loft
        loft = Place(
            title="Loft Moderne Marais",
            description="Un espace chic au coeur de Paris.",
            price=95.0,
            latitude=48.8566,
            longitude=2.3522,
            owner_id=admin.id
        ...
        villa = Place(
            ...
            description="Vue mer et piscine à débordement.",
            price=212.0,
            latitude=43.7102,
            longitude=7.2620,
            owner_id=alice.id
        ...
        cabane = Place(
            ...
            description="Calme absolu dans les sapins.",
            price=49.0,
            latitude=45.7640,
            longitude=4.8357,
            owner_id=bob.id
        ...
        rev1 = Review(
            text="Super séjour, l'admin est très réactif !",
            rating=5,
            place_id=loft.id,
            user_id=alice.id
        )
        ...
        rev2 = Review(
            text="Un peu cher mais la piscine est incroyable.",
            rating=4,
            place_id=villa.id,
            user_id=bob.id
        )
        ...
        rev3 = Review(
            text="Idéal pour déconnecter, rustique mais propre.",
            rating=5,
            place_id=cabane.id,
            user_id=admin.id
        )
