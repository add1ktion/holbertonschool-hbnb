...
class Place(BaseModel):
    """Represents a place/house in the HBnB system."""
    ...
    owner = db.relationship(
        'User', foreign_keys=[_owner_id], backref='places', lazy=True
    )
    amenities = db.relationship('Amenity', secondary=place_amenity, lazy=True)
    reviews = db.relationship('Review', backref='place', lazy=True)

    def __init__(self, title, price, longitude, latitude, owner_id,
                 description="", **kwargs):
    ...
    def title(self, value):
        """Sets the title of the place with validation."""
    ...
    def latitude(self, value):
        """Sets the latitude with validation."""
        if not isinstance(value, (float, int)):
    ...
    def longitude(self, value):
        """Sets the longitude with validation."""
        if not isinstance(value, (float, int)):
